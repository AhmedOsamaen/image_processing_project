...
var port = 3000;
var mainImgsDir = './assets/imgs';
var processedImgsDir = './assets/loaded-imgs/';
var accessImgsDir = "assets\\loaded-imgs\\";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    savedFileName = processedImgsDir + imgName + '_' + imgWidth + '_' + imgHeight + '.jpg';
                    accessFile = accessImgsDir + imgName + '_' + imgWidth + '_' + imgHeight + '.jpg';
...
function processImg(fileName, imgWidth, imgHeight) {
    var img = mainImgsDir + '/fjord.jpg';
    var savedFileName = processedImgsDir + fileName + '_' + imgWidth + '_' + imgHeight + '.jpg';
